# Trabajo Práctico: Análisis de cDNA-seq usando secuenciación por lecturas largas (ONT)

## 1. Introducción

El objetivo de este trabajo práctico es introducir el uso de **secuenciación de lecturas largas (Oxford Nanopore Technologies, ONT)** aplicada a **cDNA-seq** para analizar la **expresión diferencial de genes (DEGs)**.
